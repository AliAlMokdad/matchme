export const SECTIONS = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 'travel', type: 'choice',
        text: 'How do you feel about travel and new experiences?',
        options: [
          { value: 'adventurer', label: '🌍 Adventurer', desc: 'Always planning the next trip' },
          { value: 'occasional', label: '🗺️ Occasional',  desc: 'Love it but need roots too' },
          { value: 'homebody',   label: '🏡 Homebody',    desc: 'Comfort of home wins every time' },
          { value: 'local',      label: '🧭 Local',       desc: 'Explore what\'s nearby first' },
        ],
      },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 'communication_freq',    type: 'choice', text: 'How often do you prefer to communicate with a partner during the day?',
        options: [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 'pda', type: 'choice',
        text: 'Public displays of affection (PDA) — where do you stand?',
        options: [
      ...
      { id: 'sustainable_living', type: 'text',  text: 'How do you feel about sustainable living — recycling, reducing waste, eco choices?', placeholder: 'Share your perspective...' },
    ],
  },
];
